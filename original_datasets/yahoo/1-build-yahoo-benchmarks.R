...
A1Benchmark <- load_anomaly_dir("original_datasets/yahoo/A1Benchmark")
save(A1Benchmark, file = "data/A1Benchmark.RData", compress = "xz")

A2Benchmark <- load_anomaly_dir("original_datasets/yahoo/A2Benchmark")
save(A2Benchmark, file = "data/A2Benchmark.RData", compress = "xz")

A3Benchmark <- load_anomaly_cp_dir("original_datasets/yahoo/A3Benchmark")
names(A3Benchmark) <- str_replace_all(names(A3Benchmark), "A3Benchmark-", "")
save(A3Benchmark, file = "data/A3Benchmark.RData", compress = "xz")

A4Benchmark <- load_anomaly_cp_dir("original_datasets/yahoo/A4Benchmark")
